    ...
    try:
        ...
        for md_file in md_files:
            try:
                ...
                if any(
                    term in filename_lower for term in ["company", "profile", "brand"]
                ):
                    category = "company"
                    tags.extend(["company", "profile", "brand"])
                elif any(
                    term in filename_lower
                    for term in ["guideline", "guide", "production"]
                ):
                    category = "guidelines"
                    ...
                    term in filename_lower for term in ["voice", "examples", "cultural"]
                ):
                    category = "voice"
    ...
    try:
        ...
        if documents:
            ...
            for doc in documents:
                ...
                print(
                    f"     Size: {doc.get('file_size', 0)} bytes | Content: {len(doc['content'])} chars"
                )
                print()
