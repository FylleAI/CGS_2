    ...
    try:
        ...
        try:
            ...
            for file_info in files:
                print(
                    f"  - {file_info['name']} ({file_info.get('metadata', {}).get('size', 'unknown')} bytes)"
                )
        ...
        for file_info in files:
            ...
            try:
                ...
                if any(
                    term in filename_lower for term in ["company", "profile", "about"]
                ):
                    category = "company"
                    tags.extend(["company", "profile"])
                elif any(
                    term in filename_lower for term in ["guideline", "guide", "style"]
                ):
                    category = "guidelines"
    ...
    try:
        ...
        if documents:
            ...
            for doc in documents:
                ...
                print(
                    f"  - {doc['title']} ({doc['category']}) - {len(doc['content'])} chars"
                )
