...
export interface QuestionCardMapping {
  card_type: string;
  field_name: string;
}
...
export interface CardsSnapshotMetadata {
...
export interface CardsSnapshot {
  ...
  metadata?: CardsSnapshotMetadata;
}
...
export interface SubmitAnswersResponse {
  ...
  cards_output?: CardsSnapshot;  // NEW: Full cards output from V2 generator
